...
extension DotVector {
     ...
     */
    internal func inc(_ key: String) -> Self { Self(merge([Dot(key: key, counter: counter(of: key) + 1)])) }
     ...
     */
    internal func merge(_ other: Self) -> Self { Self(MergingDotIterator(self, other)) }
}
